...
export function Facebook(svgProps: SVGProps<SVGSVGElement>) {
  return (
    <div className='fill-current text-gray-700 hover:text-primary-500 dark:text-gray-200'>
...
export function Substack(svgProps: SVGProps<SVGSVGElement> ){
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"{...svgProps}><path fill="currentColor" d="M22.539 8.242H1.46V5.406h21.08zM1.46 10.812V24L12 18.11L22.54 24V10.812zM22.54 0H1.46v2.836h21.08z"/></svg>
  )
}
